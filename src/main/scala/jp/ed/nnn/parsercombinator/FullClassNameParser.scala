...
object FullClassNameParser extends MyFirstCombinator {
  ...
  def apply(input: String): ParseResult[FullClassName] = map(combine(combine(grade, s("年")), combine(className, s("組")) ), {
    t: ((String, String), (String, String)) => FullClassName(t._1._1, t._2._1)
  })(input)
